            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-semibold">Create Your Hashtags</h2>
                </div>
                  ...
                  >
                    <div className="relative p-6 rounded-lg bg-gradient-to-br from-purple-500/5 via-pink-500/5 to-blue-500/5 border border-primary/10">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="font-medium text-lg">Generated Hashtags</h3>
                      </div>
                      <div className="prose prose-sm max-w-none">
                        <div className="flex flex-wrap gap-2">
                          {generatedHashtags.map((hashtag, idx) => (
                            <span
                              key={idx}
                              className="px-2 py-1 rounded-md bg-primary/10 text-sm font-medium"
                            >
                              {hashtag}
                            </span>
                          ))}
                      ...
                      <div className="flex items-center justify-between text-sm text-muted-foreground pt-4 border-t mt-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{generatedHashtags.length} hashtags</span>
                        </div>
