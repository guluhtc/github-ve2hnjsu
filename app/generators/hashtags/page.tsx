            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold">Generate Hashtags</h2>
                </div>
                <Button
                  variant="outline"
                  size="sm"
              ...
              <AnimatePresence>
                {showOptions && (
                  ...
                  >
                    <HashtagOptions onOptionsChange={setOptions} />
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <div className="space-y-3 sm:space-y-4">
                <p className="text-sm sm:text-base text-muted-foreground">
                  Describe your post or content for relevant hashtags.
                </p>
                <Textarea
                  placeholder="E.g., A beautiful sunset photo at the beach..."
                  value={prompt}
                ...
                >
                  <div className="relative p-3 sm:p-4 md:p-6 rounded-lg bg-gradient-to-br from-purple-500/5 via-pink-500/5 to-blue-500/5 border border-primary/10">
                    ...
                    <div className="flex items-center gap-2 mb-3 sm:mb-4">
                      ...
                      <h3 className="font-medium text-base sm:text-lg">Generated Hashtags</h3>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {generatedContent.map((hashtag, index) => (
                        <Badge
                          key={index}
                          variant="secondary"
                    ...
                    <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs sm:text-sm text-muted-foreground gap-1 sm:gap-2">
                      <span>Click the copy button to copy all hashtags</span>
